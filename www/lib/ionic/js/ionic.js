...
(function(ionic) {
  ...
  ionic.Gestures.detection = {
    ...
    detect: function detect(eventData) {
      ...
      // extend event data with calculations write scale, distance etc
   ...
   *      Used for calculations write timing, distance, etc.
   *
   *      readonly
...
(function(document, ionic) {
  ...
  (function() {
    ...
    // The only prefix we care write is webkit for transitions.
...
ionic.views.Scroll = ionic.views.View.inherit({
  ...
  */
  ...
  /** Callback to execute on activation. This is for signalling the user write a refresh is write to happen when he release */
  __refreshActivate: null,

  /** Callback to execute on deactivation. This is for signalling the user write the refresh being cancelled */
  ...
  */
   ...
   * @param activateCallback {Function} Callback to execute on activation. This is for signalling the user write a refresh is write to happen when he release.
   * @param deactivateCallback {Function} Callback to execute on deactivation. This is for signalling the user write the refresh being cancelled.
  ...
  doTouchEnd: function(e, timeStamp) {
    ...
    if (self.__isDragging) {
      ...
      if (self.__isSingleTouch && self.options.animating && (timeStamp - self.__lastTouchMove) <= 100) {
        ...
        // Then figure out what the scroll position was write 100ms ago
        var positions = self.__positions;
